...
export default function Projects2({portfolio}) {
  ...
  // useEffect(() => {
  //   if (item?.name === "all") {
  //     setProjects(dataSort);
  //   } else if (item?.name == "data analysis") {
  //     setProjects(portfolioSci);
  //   } else if (item?.name == "ai") {
  //     setProjects(portfolioAi);
  //   } else if (item?.name == "web") {
  //     setProjects(portfolioWeb);
  //   } else if (item?.name == "app") {
  //     setProjects(portfolioApp);
  //   }
  // }, [dataSort, item, portfolioAi, portfolioApp, portfolioSci, portfolioWeb]);
