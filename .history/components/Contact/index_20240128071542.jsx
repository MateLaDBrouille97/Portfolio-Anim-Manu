  ...
  return (
    <motion.div style={{ y }} ref={container} className="contact">
      <div className="body">
        ...
        <div className="nav">
          <Link href="https://mail.google.com/mail/?view=cm&fs=1&to=mlab33972@gmail.com">
            <Rounded>
              <p>{user?.email}</p>
            </Rounded>
          </Link>
          <Link href="https://api.whatsapp.com/send?phone=15146490492&text=Hello">
            <Rounded>
              <p>+1 514 ### ##92</p>
            </Rounded>
          </Link>
        ...
        <div className="info">
          ...
          <div>
            ...
            <Link href="https://www.linkedin.com/in/manuel-thomas-labridy-70220a3a">
              <Magnetic>
                <p>Linkedin</p>
              </Magnetic>{" "}
            </Link>
